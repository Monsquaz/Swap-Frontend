      ...
      <section class="content-box column is-three-quarters">
        <div>
          ...
          <div style="text-align: center; margin-top: 15px;">
            <iframe class="youtube" src="https://player.twitch.tv/?autoplay=false&video=v310986511" frameborder="0" allowfullscreen="true" scrolling="no" height="315" width="560"></iframe>
